...
console.log(isPersonOldEnoughToDrive(obj1));
...
var output = removeNumberValues(inputObj);
console.log(output);
...
function getNthElementOfProperty(obj, key, n) {
  // your code here
//inputs: obj, key, nth element
//output: number
//edge cases:
  //array.length === 0, undefined
  //n >= obj[key].length , undefined
  //!Array.isArray(obj[key]), undefined
  //!obj.hasOwnProperty(key), undefined
...
function getLastElementOfProperty(obj, key) {
  ...
  if !Array.isArray(obj[key]); undefined;
  if obj[key] ; undefined;
  else obj[key].pop(); undefined;
    */
  ...
  if(!Array.isArray(obj[key])) {
    ...
    for (var element in obj[key]) {
      if (obj[key][element] % 2 !== 0) {
        oddElements.push(obj[key][element]);
      }
    }
  return oddElements;
  /* END SOLUTION */
...
function getEvenElementsAtProperty(obj, key) {
  ...
  if(!Array.isArray(obj[key])) {
    ...
    for (var element in obj[key]) {
      if (obj[key][element] % 2 === 0) {
        evenElements.push(obj[key][element]);
      }
    }
  return evenElements;
  /* END SOLUTION */
...
function modulo(num1, num2) {
  ...
  //asign new var for result of num1 - product for get a modulo
